...
public class Board {
    ...
    public void init(){
        ...
        fields[8] = new GovTaxField("Valby Langgade", Color.YELLOW, Color.black);
        fields[9] = new BuildableField("Valby Langgade", Color.YELLOW, Color.black, 3,rent, 1200, 1000);
        fields[10] = new BuildableField("Valby Langgade1", Color.pink, Color.black, 3,rent, 1200, 1000);
        fields[11] = new BuildableField("Valby Langgade2", Color.magenta, Color.black, 3,rent, 1200, 1000);
        fields[12] = new BuildableField("Valby Langgade3", Color.BLUE, Color.black, 3,rent, 1200, 1000);
        fields[13] = new BuildableField("Valby Langgade4", Color.cyan, Color.black, 3,rent, 1200, 1000);
        fields[14] = new BuildableField("Valby Langgade5", Color.ORANGE, Color.black, 3,rent, 1200, 1000);
        fields[15] = new BuildableField("Valby Langgade6", Color.RED, Color.black, 3,rent, 1200, 1000);
        fields[16] = new BuildableField("Valby Langgade7", Color.white, Color.black, 3,rent, 1200, 1000);
